...
def restart_service_group(service_group):
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'message': f'Failed to restart service group: {str(e)}'
        }), 500
...
def get_service_dependencies(service_name):
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'message': f'Failed to get service dependencies: {str(e)}'
        }), 500
...
def check_service_ports():
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'message': f'Failed to check service ports: {str(e)}'
        }), 500
...
def service_quick_actions():
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'message': f'Failed to perform quick action: {str(e)}'
        }), 500