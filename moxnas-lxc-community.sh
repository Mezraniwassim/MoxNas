...
echo -e "${APP} should be reachable by going to the following URL.
         ...
         ${BL}Username:${CL} admin
         ${BL}Password:${CL} moxnas1234
         
         ${BL}SSH Access:${CL} root@${IP}
         ${BL}SSH Password:${CL} moxnas1234
         
         ${BL}SMB Share:${CL} //${IP}/moxnas-storage
         ${BL}NFS Share:${CL} ${IP}:/mnt/storage
         ${BL}FTP Server:${CL} ftp://${IP}"